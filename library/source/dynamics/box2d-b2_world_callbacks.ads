...
is
   ...
   type b2ContactImpulse is
      record
           normalImpulses  : b2_Math.Reals (0 .. b2_Common.b2_maxManifoldPoints - 1);
           tangentImpulses : b2_Math.Reals (0 .. b2_Common.b2_maxManifoldPoints - 1);
           Count           : Natural;
      end record;
   ...
   procedure destruct (Self : in out b2ContactListener) is null;
   ...
   procedure beginContact (Self : in out b2ContactListener;   contact : in out b2_Contact.b2Contact'Class) is null;
   ...
   procedure endContact (Self : in out b2ContactListener;   contact : in out b2_Contact.b2Contact'Class) is null;
   ...
   procedure preSolve (Self : in out b2ContactListener;   contact     : in out b2_Contact  .b2Contact'Class;
                                                          oldManifold : in     b2_Collision.b2Manifold) is null;
   ...
   procedure postSolve (Self : in out b2ContactListener;   contact : in out b2_Contact.b2Contact'Class;
